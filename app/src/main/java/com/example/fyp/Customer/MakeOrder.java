    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        bookOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cName.equals("")||ordername.equals("") || cCnic.equals("") || cNumber.equals("") || rName.equals("") || rCnic.equals("") || rNumber.equals("") || truckType==0 || paymnetMethod == 0) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICKUP_PLACE_PICKER_REQUEST) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                System.out.println("Logititue and latituede ======================================= ");
